...
COMPILEOPTION_CFLAGS+= -I$(LIB_DIR)
export COMPILEOPTION_CFLAGS

COMPILEOPTION_LDFLAGS=
COMPILEOPTION_LDFLAGS+= -L$(LIB_DIR) -lcompileoption
...
TC_CFLAGS+=-DTCSUPPORT_NEWTOOLCHAIN
...
#__Tina__, TCSUPPORT_WAN_ITF_LIMIT is not ori export
...
TC_CFLAGS+=-TCSUPPORT_ORN_EBTABLES
endif
...
ifneq ($(strip $(ZYXEL_LAN_STAT_PROC)),)
export ZYXEL_LAN_STAT_PROC=1
TC_CFLAGS+=-DZYXEL_LAN_STAT_PROC
endif
...
#__zyxel__, remind#36462
ifneq ($(strip $(TCSUPPORT_WAN_PORT)),)
export TCSUPPORT_WAN_PORT
endif
...
#__Tina__, TCSUPPORT_FTP_CMD is not ori export&TC_CFLAGS
...
ifneq ($(strip $(ZYXEL_GEMPORT_RATE_LIMIT)),)
export ZYXEL_GEMPORT_RATE_LIMIT
TC_CFLAGS+=-DZYXEL_GEMPORT_RATE_LIMIT
endif

ifneq ($(strip $(ZYXEL_BRIDGE_MAC_LIMIT)),)
export ZYXEL_BRIDGE_MAC_LIMIT=1
TC_CFLAGS+=-DZYXEL_BRIDGE_MAC_LIMIT
endif
