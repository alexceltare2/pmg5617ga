...
#define ZYXEL_VOICE_DUMP_SIP_PACKET_ONLY 1
...
//JeremyTu.20180713.B: Add for zyims debugging
#define ZYXEL_ZYIMS_CMD_TEST	1
#if defined (PLATFORM_MTK_EVA_CODE)
#define ZYXEL_ZYIMS_CMD_MTK_EVA_DEBUG	1
#else
#define ZYXEL_ZYIMS_CMD_MTK_EVA_DEBUG	0
#endif
//JeremyTu.20180713.E: Add for zyims debugging

//JeremyTu.20180716.B: Workaround for codec 98(G.726-32) transfer to other codec issue in EVA platform
#if defined (PLATFORM_MTK_EVA_CODE)
#define ZYXEL_DONT_USE_G726_32_FOR_RESERVE_CODEC	1
#else
#define ZYXEL_DONT_USE_G726_32_FOR_RESERVE_CODEC	0
#endif
//JeremyTu.20180716.E: Workaround for codec 98(G.726-32) transfer to other codec issue in EVA platform
...
//--------------------------------------------
	...
	#define ZYXEL_VISUAL_MWI_SUPPORT	1
#endif //ZYXEL_VOIP_MWI_SUPPORT.
//--------------------------------------------
...
#if ZYXEL_VOICE_ECHO_CANCEL_DISABLE_IN_DTMF_DETECT
	#define ZYXEL_VOICE_ECHO_CANCEL_DISABLE_IN_DTMF_DETECT 1
#endif
